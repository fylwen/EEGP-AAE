...
def resize_images(images, size, method='bilinear', align_corners=False):
    ...
    return tensorflow.image.resize_images(images, size, methods[method], align_corners)#tensorflow.compat.v1.image.resize_images(images, size, methods[method], align_corners)
